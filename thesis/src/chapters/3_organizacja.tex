...
W testach porównujących klastry self-hosted z Memorystore konieczne jest dopasowanie zasobów przydzielonych podom Valkey i Redis 7.2 do parametrów usługi zarządzanej. Typ węzła \texttt{redis-standard-small} zgodnie z dokumentacją~\cite{gcpMemorystoreNodeTypes} oferuje 2~vCPU i około 7~GiB pamięci całkowitej na shard, z czego około 5{,}2~GiB jest dostępne jako pamięć użytkowa po odjęciu narzutu systemowego.
...
vCPU na shard & 2 & 2 & 2 \\
Pamięć na shard & 7 GiB & 7 GiB & $\approx$7 GiB \\
\texttt{maxmemory} & 5200 MB & 5200 MB & $\approx$5{,}2 GiB \\
...
\begin{enumerate}
    ...
    \item wypełnienie klastra za pomocą dedykowanego skryptu seedującego liczbą kluczy wystarczającą do osiągnięcia 100\% limitu \texttt{maxmemory} (3\,145\,728 kluczy o rozmiarze 1~KB przy limicie 3072~MB na shard);
