...
Badane systemy -- Valkey w wersji 9.0.1 oraz Redis -- zostały wdrożone w postaci klastrów na Kubernetes z wykorzystaniem narzędzia Helm do zarządzania konfiguracją i cyklem życia instalacji. Do wdrożenia Valkey wykorzystano oficjalny chart \texttt{valkey-io/valkey-helm} w wersji 0.9.3. W momencie realizacji pracy wsparcie dla trybu klastrowego (cluster mode) w tym charcie nie było jeszcze częścią oficjalnego wydania i było dostępne wyłącznie w formie otwartego pull requesta w repozytorium projektu. Obrazy kontenerów budowano przy użyciu Dockera. Obraz bazowy narzędzia obciążeniowego opierał się na \texttt{redislabs/memtier\_benchmark}, rozszerzonym o \texttt{kubectl} w wersji 1.30.0 umożliwiający interakcję z klastrem Kubernetes z poziomu podów testowych.
