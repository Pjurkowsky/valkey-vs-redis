...
Badane systemy -- Valkey w wersji 9.1 oraz Redis -- zostały wdrożone w postaci klastrów na Kubernetes z wykorzystaniem narzędzia Helm do zarządzania konfiguracją i cyklem życia instalacji.
